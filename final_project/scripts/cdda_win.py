...
def window_for_cdda():
    # Window Setup For Cdda :
    cdda_win = Tk()
    cdda_win.resizable(height = False, width = False)
    cdda_win.title("CDDA")
    cdda_win.geometry("550x520+0+0")
    cdda_win.config(bg = "gold2")

    # Control Variables For This Layout :
    cdda_sep_var = StringVar(cdda_win, name = "sep", value = str("--------------------------------------------------------------------"))
    cdda_x_val_label_var = StringVar(cdda_win, name = "x_value", value = str("Set X-Value = "))
    cdda_step_x_val_label_var = StringVar(cdda_win, name = "x_step_size_val", value = str("Set Step-Size(Delta-X) = "))
    cdda_big_sep_var = StringVar(cdda_win, name = "large_separator", value = str("===================================================================="))

    # Main Title :
    cdda_title = Label(cdda_win, bg = "khaki", fg = "DodgerBlue2", font = ("Times New Roman", 25, "bold"), text = str("CDDA Method's Approximated Values"), anchor = CENTER, relief = GROOVE, padx = 14, pady = 2, height = 2, width = -10)
    cdda_title.place(x = -16.0, y = 0.0)

    # Label For Function Scale :
    label_for_func = Label(cdda_win, font = ("Times New Roman", 7, "italic", "bold"), anchor = CENTER, relief = FLAT, fg = "blue2", bg = "gold2", text = str("Select A Function To Be Derived -> F(X) = "))
    label_for_func.place(x = 15.0, y = 90.0)

    # Selections Scale :
    scale_for_func = Scale(cdda_win, from_ = 1, to = 12, cursor = "dot", highlightbackground = "DodgerBlue2", activebackground = "cyan3")
    scale_for_func.place(x = 215.0, y = 90.0)

    # Access To Functions :
    help_access = Button(cdda_win, justify = CENTER, height = 2, width = 10, bg = "turquoise1", fg = "black", text = "HELP", font = ("Times New Roman", 14, "bold"), activebackground = "white", activeforeground = "white", relief = RAISED, command = lambda: functions_list_window())
    help_access.place(x = 45.0, y = 115.0)

    # Separator :
    little_sep = Label(cdda_win, bg = "gold2", fg = "black", textvariable = cdda_sep_var)
    little_sep.place(x = -1.0, y = 195.0)

    # Label For X-Value Input :
    x_value_label = Label(cdda_win, font = ("Times New Roman", 12, "italic", "bold"), anchor = CENTER, textvariable = cdda_x_val_label_var, relief = FLAT, fg = "blue2", bg = "gold2")
    x_value_label.place(x = 15.0, y = 215.0)

    # Entry For X-Value Input :
    x_value_entry = Entry(cdda_win, font = ("Times New Roman", 12, "bold"), bg = "snow4", fg = "black", justify = LEFT, relief = SUNKEN, width = 28)
    x_value_entry.place(x = 120.0, y = 217.0)

    # Separator 2 :
    little_sep2 = Label(cdda_win, bg = "gold2", fg = "black", textvariable = cdda_sep_var)
    little_sep2.place(x = -1.0, y = 240.0)

    # Label For Delta-X Input :
    delta_x_input_label = Label(cdda_win, font = ("Times New Roman", 12, "bold", "italic"), anchor = CENTER, textvariable = cdda_step_x_val_label_var, relief = FLAT, fg = "blue2", bg = "gold2")
    delta_x_input_label.place(x = 15.0, y = 257.0)

    # Entry For Delta-X Input :
    delta_x_input_entry = Entry(cdda_win, font = ("Times New Roman", 12, "bold"), bg = "snow4", fg = "black", justify = LEFT, relief = SUNKEN, width = 20)
    delta_x_input_entry.place(x = 185.0, y = 259.0)

    # Large Separator :
    big_sep = Label(cdda_win, bg = "gold2", fg = "black", textvariable = cdda_big_sep_var)
    ...
    # Label For Entry[1][0] :
    exact_label = Label(cdda_win, justify = CENTER, height = 1, width = 12, bg = "black", fg = "gold2", text = str("Exact Value = "), font = ("Times New Roman", 18, "bold"), relief = RIDGE)
    exact_label.place(x = 16.0, y = 370.0)

    # Entry[1][0] :
    exact_entry = Entry(cdda_win, justify = LEFT, width = 29, bg = "orange", fg = "black", font = ("Times New Roman", 18, "bold"), relief = RIDGE)
    exact_entry.place(x = 190.0, y = 371.0)

    # Label For Entry[1][1] :
    appr_label = Label(cdda_win, justify = CENTER, height = 1, width = 14, bg = "black", fg = "gold2", text = str("Approx. Value = "), font = ("Times New Roman", 16, "bold"), relief = RIDGE)
    appr_label.place(x = 16.0, y = 425.0)

    # Entry[1][1] :
    appr_entry = Entry(cdda_win, justify = LEFT, width = 29, bg = "orange", fg = "black", font = ("Times New Roman", 18, "bold"), relief = RIDGE)
    appr_entry.place(x = 190.0, y = 425.0)

    # Label For Entry [1][2] :
    abs_error_label = Label(cdda_win, justify = CENTER, height = 2, width = 24, bg = "black", fg = "gold2", text = str("Abs. Relative True Error(%) = "), font = ("Times New Roman", 10, "bold"), relief = RIDGE)
    abs_error_label.place(x = 16.0, y = 475.0)

    # Entry[1][2] :
    abs_error_entry = Entry(cdda_win, justify = LEFT, width = 29, bg = "orange", fg = "black", font = ("Times New Roman", 18, "bold"), relief = RIDGE)
    abs_error_entry.place(x = 190.0, y = 478.0)

    # Method Implementations :
    class CDDA_Window_Methods(Exception):
        ...
        def calculate_all(self):
            ...
            if(int(scale_for_func.get()) == 1):
                ...
                appr_value = float(derivative(func = np.exp, x0 = float(x_value_entry.get()), dx = float(delta_x_input_entry.get())))
                ...
                # Calculations :
                exact_value = derived_func(float(x_value_entry.get()))
                appr_value = derivative(func = np.log, x0 = float(x_value_entry.get()), dx = float(delta_x_input_entry.get()))
                abs_error_value = (np.abs(((exact_value - appr_value) / exact_value))) * float(100.0)
                self.clear_all()
                # Insertions :
                exact_entry.insert(self.__length_of_exact_entry, str(round(exact_value, 5)))
                ...
                # Calculations :
                exact_value = derived_func(float(x_value_entry.get()))
                appr_value = derivative(func = function, x0 = float(x_value_entry.get()), dx = float(delta_x_input_entry.get()))
                abs_error_value = (np.abs(((exact_value - appr_value) / exact_value))) * float(100.0)
                self.clear_all()
                # Insertions :
                exact_entry.insert(self.__length_of_exact_entry, str(round(exact_value, 5)))
                ...
                # Calculations :
                exact_value = derived_func(float(x_value_entry.get()))
                appr_value = derivative(func = np.sin, x0 = math.radians(float(x_value_entry.get())), dx = math.radians(float(delta_x_input_entry.get())))
                abs_error_value = (np.abs(((exact_value - appr_value) / exact_value))) * float(100.0)
                self.clear_all()
                # Insertions :
                exact_entry.insert(self.__length_of_exact_entry, str(round(exact_value, 5)))
                ...
                # Calculations :
                exact_value = derived_func(float(x_value_entry.get()))
                appr_value = derivative(func = np.cos, x0 = math.radians(float(x_value_entry.get())), dx = math.radians(float(delta_x_input_entry.get())))
                abs_error_value = (np.abs(((exact_value - appr_value) / exact_value))) * float(100.0)
                self.clear_all()
                # Insertions :
                exact_entry.insert(self.__length_of_exact_entry, str(round(exact_value, 5)))
                ...
                # Calculations :
                exact_value = derived_func(float(x_value_entry.get()))
                appr_value = derivative(func = np.tan, x0 = math.radians(float(x_value_entry.get())), dx = math.radians(float(delta_x_input_entry.get())))
                abs_error_value = (np.abs(((exact_value - appr_value) / exact_value))) * float(100.0)
                self.clear_all()
                # Insertions :
                exact_entry.insert(self.__length_of_exact_entry, str(round(exact_value, 5)))
    ...
    # Instantiation.
    execute = CDDA_Window_Methods()
    # Calculate Button.
    calculate_btn = Button(cdda_win, justify = CENTER, height = 1, width = 12, bg = "turquoise1", fg = "IndianRed1", text = str("CALCULATE"), font = ("Times New Roman", 14, "bold"), activebackground = "white", activeforeground = "white", relief = RAISED, command = lambda: execute.calculate_all())
    calculate_btn.place(x = 15.0, y = 310.0)

    # Save Button.
    save_btn = Button(cdda_win, justify = CENTER , height = 1, width = 12, bg = "turquoise1", fg = "IndianRed1", text = str("SAVE"), font = ("Times New Roman", 14, "bold"), activebackground = "white", activeforeground = "white", relief = RAISED, command = lambda: execute.save_results())
    save_btn.place(x = 200.0, y = 310.0)

    # Clear Button.
    clear_btn = Button(cdda_win, justify = CENTER , height = 1, width = 12, bg = "turquoise1", fg = "IndianRed1", text = str("CLEAR"), font = ("Times New Roman", 14, "bold"), activebackground = "white", activeforeground = "white", relief = RAISED, command = lambda: execute.clear_all())
